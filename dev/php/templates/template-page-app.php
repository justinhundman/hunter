	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<div class="u-gridContainer wrapper-content u-gridRow">
				...
				<div class=" u-gridCol12">
					...
					<div class="wrapper-content-left u-gridRow">
						<p class=" u-gridCol12">
						 ...
						 <a class="u-gridCol6 text-align-center" href"#">
						 ...
						 <a class="u-gridCol6" href"#"> <img  src="<?php echo get_stylesheet_directory_uri(); ?>/img/placeholder_qr_code.jpg"/></a>
					</div>	
			...
			<div class="iphoneback u-gridCol4 ">
				<img class="iphone-image" src="<?php echo get_stylesheet_directory_uri(); ?>/img/iphone6plus_gold_portrait.png"/>
			</div>
		</div> 	
	<?php endwhile; endif; ?> 
